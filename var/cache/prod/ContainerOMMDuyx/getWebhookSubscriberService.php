...
class getWebhookSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\EmailBundle\\EventListener\\WebhookSubscriber'] = new \Mautic\EmailBundle\EventListener\WebhookSubscriber($a, $container->getEnv('bool:resolve:MAUTIC_WEBHOOK_EMAIL_DETAILS'));
    }
}
