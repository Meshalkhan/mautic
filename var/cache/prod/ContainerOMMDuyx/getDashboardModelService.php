...
class getDashboardModelService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\DashboardBundle\\Model\\DashboardModel'] = new \Mautic\DashboardBundle\Model\DashboardModel(($container->services['mautic.helper.core_parameters'] ?? ($container->services['mautic.helper.core_parameters'] = new \Mautic\CoreBundle\Helper\CoreParametersHelper($container))), ($container->services['mautic.helper.paths'] ?? $container->getMautic_Helper_PathsService()), ($container->services['Mautic\\DashboardBundle\\Factory\\WidgetDetailEventFactory'] ?? $container->load('getWidgetDetailEventFactoryService')), ($container->services['mautic.filesystem'] ?? ($container->services['mautic.filesystem'] = new \Mautic\CoreBundle\Helper\Filesystem())), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), $a, ($container->services['mautic.security'] ?? $container->getMautic_SecurityService()), $b, $c, ($container->services['Mautic\\CoreBundle\\Translation\\Translator'] ?? $container->getTranslatorService()), ($container->services['mautic.helper.user'] ?? $container->getMautic_Helper_UserService()), ($container->services['monolog.logger.mautic'] ?? $container->getMonolog_Logger_MauticService()));
    }
}
