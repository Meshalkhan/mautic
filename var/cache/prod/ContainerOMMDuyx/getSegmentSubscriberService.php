...
class getSegmentSubscriberService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Mautic\\LeadBundle\\EventListener\\SegmentSubscriber'] = new \Mautic\LeadBundle\EventListener\SegmentSubscriber(($container->services['mautic.helper.ip_lookup'] ?? $container->getMautic_Helper_IpLookupService()), $a, $b, ($container->services['mautic.lead.validator.lead.list.campaign'] ?? $container->load('getMautic_Lead_Validator_Lead_List_CampaignService')), ($container->services['translator'] ?? $container->getTranslator2Service()));
    }
}
