...
class Form extends \Mautic\FormBundle\Entity\Form implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'id', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'language', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'name', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'formAttributes', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'description', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'alias', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'category', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'cachedHtml', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'postAction', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'postActionProperty', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'fields', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'actions', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'template', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'inKioskMode', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'renderStyle', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'submissions', 'submissionCount', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'formType', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'noIndex', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'progressiveProfilingLimit', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Form' . "\0" . 'usesProgressiveProfiling', 'changes', 'new', 'deletedId', 'pastChanges'];
        }
     ...
     * {@inheritDoc}
     */
    public function removeField($key, \Mautic\FormBundle\Entity\Field $field): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeField', [$key, $field]);

        parent::removeField($key, $field);
    }
    ...
    public function getMappedFieldValues(): array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMappedFieldValues', []);

        return parent::getMappedFieldValues();
    }
     ...
     * {@inheritDoc}
     */
    public function removeSubmission(\Mautic\FormBundle\Entity\Submission $submissions): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSubmission', [$submissions]);

        parent::removeSubmission($submissions);
    }
     ...
     * {@inheritDoc}
     */
    public function removeAction(\Mautic\FormBundle\Entity\Action $action): void
    {
    ...
    public function setInKioskMode($inKioskMode): void
    {
        ...
        parent::setInKioskMode($inKioskMode);
    }
    ...
    public function setRenderStyle($renderStyle): void
    {
        ...
        parent::setRenderStyle($renderStyle);
    }
     ...
     * {@inheritDoc}
     */
    public function setLanguage(?string $language): \Mautic\FormBundle\Entity\Form
    {
