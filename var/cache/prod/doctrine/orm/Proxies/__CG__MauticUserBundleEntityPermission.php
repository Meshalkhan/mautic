 ...
 */
class Permission extends \Mautic\UserBundle\Entity\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'bundle', 'name', 'role', 'bitwise'];
        }
    ...
    public function setBitwise($bitwise)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBitwise', [$bitwise]);

        return parent::setBitwise($bitwise);
    }
    ...
    public function getBitwise()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBitwise', []);

        return parent::getBitwise();
    }
