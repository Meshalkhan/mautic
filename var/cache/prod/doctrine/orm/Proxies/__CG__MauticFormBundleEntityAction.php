 ...
 */
class Action extends \Mautic\FormBundle\Entity\Action implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'id', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'name', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'description', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'type', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'order', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'properties', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'form', '' . "\0" . 'Mautic\\FormBundle\\Entity\\Action' . "\0" . 'changes'];
        }
