...
class Role extends \Mautic\UserBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function removePermission(\Mautic\UserBundle\Entity\Permission $permissions): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePermission', [$permissions]);

        parent::removePermission($permissions);
    }
    ...
    public function setRawPermissions(array $permissions): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRawPermissions', [$permissions]);

        parent::setRawPermissions($permissions);
    }
    ...
    public function getRawPermissions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRawPermissions', []);
     ...
     * {@inheritDoc}
     */
    public function removeUser(\Mautic\UserBundle\Entity\User $users): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUser', [$users]);

        parent::removeUser($users);
    }
