...
class __TwigTemplate_7b3c3f20b308b5cf046605177144efb6 extends Template
{
    private $source;
    private $macros = [];
...
class AssetController extends FormController
{
    ...
    public function newAction(Request \$request, CoreParametersHelper \$parametersHelper, UploaderHelper \$uploaderHelper, AssetModel \$model, \$entity = null)
    {
        ...
        \$maxSizeError = \$this->translator->trans('mautic.asset.asset.error.file.size', [
            '%fileSize%' => '";
        // line 291
        echo twig_escape_filter($this->env, (isset($context["filesize"]) || array_key_exists("filesize", $context) ? $context["filesize"] : (function () { throw new RuntimeError('Variable "filesize" does not exist.', 291, $this->source); })()), "html", null, true);
        echo "',
            '%maxSize%'  => '";
        // line 292
    ...
    public function editAction(Request \$request, UploaderHelper \$uploaderHelper, AssetModel \$model, \$objectId, \$ignorePost = false)
    {
        ...
        \$maxSizeError = \$this->translator->trans('mautic.asset.asset.error.file.size', [
            '%fileSize%' => '";
        // line 423
        echo twig_escape_filter($this->env, (isset($context["filesize"]) || array_key_exists("filesize", $context) ? $context["filesize"] : (function () { throw new RuntimeError('Variable "filesize" does not exist.', 423, $this->source); })()), "html", null, true);
        echo "',
            '%maxSize%'  => '";
        // line 424
        echo twig_escape_filter($this->env, (isset($context["maxFilesize"]) || array_key_exists("maxFilesize", $context) ? $context["maxFilesize"] : (function () { throw new RuntimeError('Variable "maxFilesize" does not exist.', 424, $this->source); })()), "html", null, true);
        echo "',
        ], 'validators');
...
";
    ...
    {
        return array (  471 => 424,  467 => 423,  333 => 292,  329 => 291,  37 => 1,);
    }
