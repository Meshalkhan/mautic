...
/* @bundles/CampaignBundle/Executioner/RealTimeExecutioner.php */
class __TwigTemplate_88957a09a9fbec8fe414bcf1ca501bbf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CampaignBundle/Executioner/RealTimeExecutioner.php";
    }
    ...
    {
        return new Source("", "@bundles/CampaignBundle/Executioner/RealTimeExecutioner.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CampaignBundle\\Executioner\\RealTimeExecutioner.php");
    }
}
