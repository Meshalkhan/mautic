...
/* @bundles/DynamicContentBundle/Helper/DynamicContentHelper.php */
class __TwigTemplate_911d9cd3c1da8e4320a9d199240db6e8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/DynamicContentBundle/Helper/DynamicContentHelper.php";
    }
    ...
    {
        return new Source("", "@bundles/DynamicContentBundle/Helper/DynamicContentHelper.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\DynamicContentBundle\\Helper\\DynamicContentHelper.php");
    }
}
