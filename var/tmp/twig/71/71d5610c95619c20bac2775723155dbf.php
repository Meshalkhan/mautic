...
class __TwigTemplate_69b10b82fb674d9da311eb0dad6c8d5e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "// Mautic note: This does not seem to be a library and perhaps should be moved to an app folder.
jQuery.fn.extend({
