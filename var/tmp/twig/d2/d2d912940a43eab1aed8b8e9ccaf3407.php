...
class __TwigTemplate_c44d6e79f825aabfec95537ff6d46dce extends Template
{
...
(isset($context["permissions"]) || array_key_exists("permissions", $context) ? $context["permissions"] : (function () { throw new RuntimeError('Variable "permissions" does not exist.', 64, $this->source); })()), "point:triggers:delete", [], "array", false, false, false, 64)], "routeBase" => "pointtrigger", "langVar" => "point.trigger"]);
                ...
                // line 95
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["color"]) || array_key_exists("color", $context) ? $context["color"] : (function () { throw new RuntimeError('Variable "color" does not exist.', 95, $this->source); })()), "html", null, true);
                yield ";\"> </span>
                          <span>";
                // line 96
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["catName"]) || array_key_exists("catName", $context) ? $context["catName"] : (function () { throw new RuntimeError('Variable "catName" does not exist.', 96, $this->source); })()), "html", null, true);
                yield "</span>
                        </span>
                    </td>
                    <td class=\"visible-md visible-lg\">
    ...
    <div class=\"panel-footer\">
        ";
            // line 110
            yield Twig\Extension\CoreExtension::include($this->env, $context, "@MauticCore/Helper/pagination.html.twig", ["totalItems" => Twig\Extension\CoreExtension::length($this->env->getCharset(),             // line 111
...
";
    ...
    {
        return array (  236 => 120,  231 => 117,  229 => 113,  228 => 112,  227 => 111,  226 => 110,  220 => 106,  203 => 103,  199 => 102,  194 => 100,  187 => 96,  183 => 95,  180 => 94,  177 => 93,  174 => 92,  172 => 91,  168 => 89,  162 => 86,  159 => 85,  157 => 84,  154 => 83,  148 => 81,  142 => 78,  137 => 77,  135 => 76,  131 => 75,  123 => 71,  118 => 68,  116 => 64,  115 => 63,  114 => 62,  113 => 60,  112 => 59,  108 => 57,  91 => 56,  85 => 52,  83 => 47,  79 => 45,  77 => 40,  73 => 38,  71 => 33,  67 => 31,  65 => 26,  61 => 24,  59 => 18,  53 => 14,  51 => 12,  50 => 6,  44 => 2,  42 => 1,);
    }
