...
/* @bundles/CoreBundle/Helper/UpdateHelper.php */
class __TwigTemplate_5ab8e2ffcc29484780a3c0d316c3e7e9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CoreBundle/Helper/UpdateHelper.php";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Helper/UpdateHelper.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Helper\\UpdateHelper.php");
    }
}
