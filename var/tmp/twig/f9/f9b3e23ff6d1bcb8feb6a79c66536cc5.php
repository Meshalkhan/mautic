...
class __TwigTemplate_f55cb0fc53f078831e6ed524fc8ccb5b extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"sidebar-content\">
                ...
                <div class=\"scroll-content slimscroll\" id=\"OffCanvasMainContent\">
                    <nav class=\"nav-sidebar\">
                        ";
        // line 24
        echo $this->extensions['Mautic\CoreBundle\Twig\Extension\MenuExtension']->menuRender("admin");
        echo "
                    </nav>
                </div>
            </div>
