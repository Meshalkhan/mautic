...
class __TwigTemplate_4625338cf7487bb7e69e7a4a0f93b05b extends Template
{
...
";
        // line 3
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), 'row');
        yield "
";
        yield from [];
    }
