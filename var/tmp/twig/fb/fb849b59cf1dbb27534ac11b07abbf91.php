...
class __TwigTemplate_74639ad92e3e72b097892b301737a25b extends Template
{
...
<head>
    ...
    <script>
        ...
        if ((isset($context["relative_path"]) || array_key_exists("relative_path", $context) ? $context["relative_path"] : (function () { throw new RuntimeError('Variable "relative_path" does not exist.', 18, $this->source); })())) {
            // line 19
            yield "                        window.opener.setValue('";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["pathPrefix"]) || array_key_exists("pathPrefix", $context) ? $context["pathPrefix"] : (function () { throw new RuntimeError('Variable "pathPrefix" does not exist.', 19, $this->source); })()), "html", null, true);
            yield "'+file.url.replace(\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 19, $this->source); })()), "request", [], "any", false, false, false, 19), "schemeAndHttpHost", [], "any", false, false, false, 19), "html", null, true);
            yield "/\", \"\"), \"";
            ...
            // line 21
            yield "                        window.opener.setValue(file.url, \"";
...
";
    ...
    {
        return array (  91 => 23,  85 => 21,  75 => 19,  73 => 18,  68 => 16,  64 => 15,  60 => 14,  50 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@FMElfinder/Elfinder/elfinder_type.html.twig", "C:\\xampp\\htdocs\\mautic\\vendor\\helios-ag\\fm-elfinder-bundle\\src\\Resources\\views\\Elfinder\\elfinder_type.html.twig");
    }
}
