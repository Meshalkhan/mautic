...
/* @bundles/NotificationBundle/Controller/NotificationController.php */
class __TwigTemplate_41102d4cbc3a6a6dd0e5ddc5f67ffd3e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/NotificationBundle/Controller/NotificationController.php";
    }
    ...
    {
        return new Source("", "@bundles/NotificationBundle/Controller/NotificationController.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\NotificationBundle\\Controller\\NotificationController.php");
    }
}
