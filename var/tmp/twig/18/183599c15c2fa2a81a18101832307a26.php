...
/* @bundles/PageBundle/PageEvents.php */
class __TwigTemplate_6c8a786de34a64136b35e413d96622b3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/PageBundle/PageEvents.php";
    }
    ...
    {
        return new Source("", "@bundles/PageBundle/PageEvents.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\PageBundle\\PageEvents.php");
    }
}
