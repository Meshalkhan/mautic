...
/* @bundles/CoreBundle/Config/config.php */
class __TwigTemplate_f9d010dd52f208e7a08c6f180221abfb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CoreBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Config\\config.php");
    }
}
