...
/* @bundles/LeadBundle/Segment/Query/ContactSegmentQueryBuilder.php */
class __TwigTemplate_166c3512a48fba664e9317477462ffc5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/LeadBundle/Segment/Query/ContactSegmentQueryBuilder.php";
    }
    ...
    {
        return new Source("", "@bundles/LeadBundle/Segment/Query/ContactSegmentQueryBuilder.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\LeadBundle\\Segment\\Query\\ContactSegmentQueryBuilder.php");
    }
}
