...
class __TwigTemplate_b9be563dcfac015ada9925d3a356d2d9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/NotificationBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\NotificationBundle\\Config\\config.php");
    }
}
