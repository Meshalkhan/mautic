...
/* @MauticForm/Field/file.html.twig */
class __TwigTemplate_ba249eddab67bd8a6ee5a151993631ee extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("inForm", $context)) ? (_twig_default_filter((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 12, $this->source); })()), false)) : (false)), "type" => "file", "id" =>         // line 14
...
array_key_exists("formName", $context)) ? (_twig_default_filter((isset($context["formName"]) || array_key_exists("formName", $context) ? $context["formName"] : (function () { throw new RuntimeError('Variable "formName" does not exist.', 17, $this->source); })()), "")) : (""))]);
    }
    ...
    {
        return "@MauticForm/Field/file.html.twig";
    }
    ...
    {
        return new Source("", "@MauticForm/Field/file.html.twig", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\FormBundle\\Resources\\views\\Field\\file.html.twig");
    }
}
