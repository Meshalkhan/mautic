...
class __TwigTemplate_ba74b60b7dabfe50824daa7f26d70100 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-md-6\">
        <div class=\"row\">
            <div class=\"form-group col-xs-12\">
                ";
        // line 5
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })()), "handle", [], "any", false, false, false, 5), 'row');
        echo "
            </div>
        </div>
    </div>
