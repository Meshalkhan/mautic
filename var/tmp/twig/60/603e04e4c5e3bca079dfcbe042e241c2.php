...
class __TwigTemplate_3a809409b83192393a9d661e7b783e45 extends Template
{
...
";
        // line 188
        $context["backButtonAttr"] = Twig\Extension\CoreExtension::merge((isset($context["backButtonAttr"]) || array_key_exists("backButtonAttr", $context) ? $context["backButtonAttr"] : (function () { throw new RuntimeError('Variable "backButtonAttr" does not exist.', 188, $this->source); })()), ["class" => Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source,         // line 189
($context["backButtonAttr"] ?? null), "class", [], "any", true, true, false, 189)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["backButtonAttr"] ?? null), "class", [], "any", false, false, false, 189), [])) : ([])), ["btn", "btn-default", "mautic-pagebreak-back"]), "type" => "button", "data-mautic-form-pagebreak-button" => "prev"]);
        // line 193
        $context["nextButtonAttr"] = Twig\Extension\CoreExtension::merge((isset($context["nextButtonAttr"]) || array_key_exists("nextButtonAttr", $context) ? $context["nextButtonAttr"] : (function () { throw new RuntimeError('Variable "nextButtonAttr" does not exist.', 193, $this->source); })()), ["class" => Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source,         // line 194
($context["nextButtonAttr"] ?? null), "class", [], "any", true, true, false, 194)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["nextButtonAttr"] ?? null), "class", [], "any", false, false, false, 194), [])) : ([])), ["btn", "btn-default", "mautic-pagebreak-next"]), "type" => "button", "data-mautic-form-pagebreak-button" => "next"]);
        // line 198
        yield "
";
        // line 199
        if (( !array_key_exists("inForm", $context) || (array_key_exists("inForm", $context) && Twig\Extension\CoreExtension::testEmpty((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 199, $this->source); })()))))) {
            // line 200
            yield "
    ";
            // line 202
            yield "    ";
            $context["containerAttributes"] = Twig\Extension\CoreExtension::merge((isset($context["containerAttributes"]) || array_key_exists("containerAttributes", $context) ? $context["containerAttributes"] : (function () { throw new RuntimeError('Variable "containerAttributes" does not exist.', 202, $this->source); })()), ["data-mautic-form-pagebreak" =>             // line 203
(isset($context["fieldPage"]) || array_key_exists("fieldPage", $context) ? $context["fieldPage"] : (function () { throw new RuntimeError('Variable "fieldPage" does not exist.', 203, $this->source); })()), "style" => Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source,             // line 204
($context["containerAttributes"] ?? null), "style", [], "any", true, true, false, 204)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["containerAttributes"] ?? null), "style", [], "any", false, false, false, 204), [])) : ([])), ["display:none;"])]);
        }
        // line 207
        yield "
";
        // line 208
        $context["prevPageLabel"] = Twig\Extension\CoreExtension::trim(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["field"] ?? null), "properties", [], "any", false, true, false, 208), "prev_page_label", [], "any", true, true, false, 208)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["field"] ?? null), "properties", [], "any", false, true, false, 208), "prev_page_label", [], "any", false, false, false, 208), "")) : ("")));
        // line 209
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["prevPageLabel"]) || array_key_exists("prevPageLabel", $context) ? $context["prevPageLabel"] : (function () { throw new RuntimeError('Variable "prevPageLabel" does not exist.', 209, $this->source); })()))) {
            // line 210
            yield "    ";
            $context["backButtonAttr"] = Twig\Extension\CoreExtension::merge((isset($context["backButtonAttr"]) || array_key_exists("backButtonAttr", $context) ? $context["backButtonAttr"] : (function () { throw new RuntimeError('Variable "backButtonAttr" does not exist.', 210, $this->source); })()), ["style" => Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source,             // line 211
($context["backButtonAttr"] ?? null), "style", [], "any", true, true, false, 211)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["backButtonAttr"] ?? null), "style", [], "any", false, false, false, 211), [])) : ([])), ["display:none;"])]);
        }
        // line 214
        yield "
<div ";
        // line 215
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["containerAttributes"]) || array_key_exists("containerAttributes", $context) ? $context["containerAttributes"] : (function () { throw new RuntimeError('Variable "containerAttributes" does not exist.', 215, $this->source); })()));
  ...
  <button ";
        // line 216
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["backButtonAttr"]) || array_key_exists("backButtonAttr", $context) ? $context["backButtonAttr"] : (function () { throw new RuntimeError('Variable "backButtonAttr" does not exist.', 216, $this->source); })()));
        foreach ($context['_seq'] as $context["attrName"] => $context["attrValue"]) {
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["attrName"], "html", null, true);
            yield "=\"";
            if (is_iterable($context["attrValue"])) {
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        yield ">";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 216, $this->source); })()), "properties", [], "any", false, false, false, 216), "prev_page_label", [], "any", false, false, false, 216), "html", null, true);
        yield "</button>
  <button ";
        // line 217
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["nextButtonAttr"]) || array_key_exists("nextButtonAttr", $context) ? $context["nextButtonAttr"] : (function () { throw new RuntimeError('Variable "nextButtonAttr" does not exist.', 217, $this->source); })()));
        foreach ($context['_seq'] as $context["attrName"] => $context["attrValue"]) {
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["attrName"], "html", null, true);
            yield "=\"";
            if (is_iterable($context["attrValue"])) {
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        yield ">";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 217, $this->source); })()), "properties", [], "any", false, false, false, 217), "next_page_label", [], "any", false, false, false, 217), "html", null, true);
        yield "</button>
</div>
";
        yield from [];
    ...
    {
        return array (  478 => 217,  458 => 216,  440 => 215,  437 => 214,  434 => 211,  432 => 210,  430 => 209,  428 => 208,  425 => 207,  422 => 204,  421 => 203,  419 => 202,  416 => 200,  414 => 199,  411 => 198,  409 => 194,  408 => 193,  406 => 189,  405 => 188,  402 => 187,  400 => 186,  398 => 185,  395 => 184,  392 => 181,  389 => 180,  386 => 179,  383 => 178,  380 => 177,  377 => 176,  375 => 175,  372 => 174,  369 => 173,  363 => 172,  360 => 171,  358 => 168,  357 => 167,  355 => 166,  352 => 165,  349 => 164,  344 => 163,  341 => 162,  339 => 161,  336 => 160,  333 => 159,  330 => 158,  327 => 157,  325 => 156,  322 => 155,  319 => 154,  316 => 153,  313 => 152,  310 => 151,  307 => 150,  304 => 149,  301 => 148,  299 => 147,  296 => 146,  293 => 145,  290 => 144,  287 => 143,  284 => 142,  281 => 141,  278 => 140,  275 => 139,  272 => 138,  269 => 137,  266 => 136,  264 => 134,  263 => 133,  261 => 132,  258 => 131,  255 => 130,  252 => 129,  249 => 128,  247 => 126,  246 => 125,  245 => 124,  244 => 123,  241 => 122,  238 => 121,  235 => 120,  232 => 119,  229 => 118,  226 => 117,  224 => 116,  221 => 111,  219 => 110,  217 => 109,  215 => 108,  212 => 107,  209 => 104,  206 => 103,  204 => 101,  203 => 100,  202 => 97,  200 => 96,  197 => 95,  194 => 94,  191 => 93,  188 => 92,  185 => 91,  183 => 90,  180 => 85,  179 => 84,  178 => 83,  177 => 82,  174 => 81,  171 => 80,  169 => 79,  167 => 78,  164 => 76,  162 => 75,  160 => 72,  159 => 71,  158 => 69,  157 => 68,  156 => 67,  153 => 64,  151 => 63,  149 => 61,  147 => 60,  144 => 57,  142 => 55,  140 => 53,  139 => 52,  136 => 51,  133 => 50,  130 => 49,  127 => 48,  125 => 47,  122 => 44,  120 => 43,  118 => 42,  115 => 41,  112 => 38,  111 => 37,  109 => 36,  107 => 34,  105 => 33,  103 => 32,  100 => 31,  97 => 28,  95 => 27,  93 => 26,  90 => 25,  87 => 22,  85 => 21,  82 => 20,  79 => 19,  76 => 18,  73 => 17,  71 => 16,  69 => 15,  67 => 14,  65 => 13,  63 => 12,  61 => 11,  59 => 10,  57 => 9,  55 => 8,  53 => 7,  51 => 6,  49 => 5,  46 => 3,  44 => 2,  42 => 1,);
    }
