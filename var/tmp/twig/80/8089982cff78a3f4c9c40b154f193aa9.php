...
class __TwigTemplate_6ab75cbdabadb9ed42f828abbc1c6c42 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("inForm", $context)) ? (_twig_default_filter((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 12, $this->source); })()), false)) : (false)), "type" => "date", "id" =>         // line 14
