...
class __TwigTemplate_bf3fd0386a26935e38a0f55f5f9e9ffd extends Template
{
    ...
    <style scoped>
        ...
        yield ";
            color: #";
        // line 23
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["props"]) || array_key_exists("props", $context) ? $context["props"] : (function () { throw new RuntimeError('Variable "props" does not exist.', 23, $this->source); })()), "colors", [], "any", false, false, false, 23), "text", [], "any", false, false, false, 23), "html", null, true);
        yield ";
        }
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["props"] ?? null), "colors", [], "any", true, true, false, 26) &&  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["props"]) || array_key_exists("props", $context) ? $context["props"] : (function () { throw new RuntimeError('Variable "props" does not exist.', 26, $this->source); })()), "colors", [], "any", false, false, false, 26)))) {
            ...
            yield "          .mf-content a.mf-link, .mf-content .mauticform-button, .mf-content .mauticform-pagebreak {
              background-color: #";
            // line 28
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["props"]) || array_key_exists("props", $context) ? $context["props"] : (function () { throw new RuntimeError('Variable "props" does not exist.', 28, $this->source); })()), "colors", [], "any", false, false, false, 28), "button", [], "any", false, false, false, 28), "html", null, true);
            yield ";
              color: #";
            // line 29
          ...
          .mauticform-input:focus, select:focus {
              border: 1px solid #";
            // line 32
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["props"]) || array_key_exists("props", $context) ? $context["props"] : (function () { throw new RuntimeError('Variable "props" does not exist.', 32, $this->source); })()), "colors", [], "any", false, false, false, 32), "button", [], "any", false, false, false, 32), "html", null, true);
            yield ";
          }
        ";
        }
