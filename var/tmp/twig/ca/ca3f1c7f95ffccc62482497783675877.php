...
class __TwigTemplate_ca92863159e291de442ffd05abfeed2b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@bundles/IntegrationsBundle/Helper/FieldValidationHelper.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\IntegrationsBundle\\Helper\\FieldValidationHelper.php");
    }
}
