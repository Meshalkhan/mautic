...
/* @bundles/ConfigBundle/Model/SysinfoModel.php */
class __TwigTemplate_cc2a59fbb0cd129772793395ce9eaab4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/ConfigBundle/Model/SysinfoModel.php";
    }
    ...
    {
        return new Source("", "@bundles/ConfigBundle/Model/SysinfoModel.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\ConfigBundle\\Model\\SysinfoModel.php");
    }
}
