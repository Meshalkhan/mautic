...
/* @bundles/EmailBundle/Config/config.php */
class __TwigTemplate_41ed3294ea0c0a0028f02aadde932650 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/EmailBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/EmailBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\EmailBundle\\Config\\config.php");
    }
}
