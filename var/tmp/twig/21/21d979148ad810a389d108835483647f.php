...
/* @bundles/UserBundle/Entity/UserRepository.php */
class __TwigTemplate_58be3858fa9e455f32f374768cbda2e5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/UserBundle/Entity/UserRepository.php";
    }
    ...
    {
        return new Source("", "@bundles/UserBundle/Entity/UserRepository.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\UserBundle\\Entity\\UserRepository.php");
    }
}
