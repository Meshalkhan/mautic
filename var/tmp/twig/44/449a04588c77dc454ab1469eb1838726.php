...
class __TwigTemplate_d7fea3960c968b4de9b964a62364cb9d extends Template
{
    private $source;
    private $macros = [];
...
a.inline-token {
  ...
  .text-muted {
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/builder/builder.less", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Assets\\builder\\builder.less");
    }
}
