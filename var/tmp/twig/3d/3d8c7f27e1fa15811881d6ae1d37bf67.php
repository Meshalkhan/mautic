...
/* @bundles/SmsBundle/Config/config.php */
class __TwigTemplate_bd4391f4ee492871601f440c2ea8d7aa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/SmsBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/SmsBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\SmsBundle\\Config\\config.php");
    }
}
