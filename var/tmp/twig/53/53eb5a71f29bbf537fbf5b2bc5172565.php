...
/* @bundles/CoreBundle/Helper/ThemeHelper.php */
class __TwigTemplate_d71039ea1be638fcc6e238ba57030c23 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CoreBundle/Helper/ThemeHelper.php";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Helper/ThemeHelper.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Helper\\ThemeHelper.php");
    }
}
