...
/* @MauticForm/Field/date.html.twig */
class __TwigTemplate_9157a341af5ae8fc5576aafa099d17cc extends Template
{
...
array_key_exists("inForm", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 12, $this->source); })()), false)) : (false)), "type" => "date", "id" =>         // line 14
...
array_key_exists("formName", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["formName"]) || array_key_exists("formName", $context) ? $context["formName"] : (function () { throw new RuntimeError('Variable "formName" does not exist.', 16, $this->source); })()), "")) : (""))]);
    ...
    {
        return "@MauticForm/Field/date.html.twig";
    }
    ...
    {
        return new Source("", "@MauticForm/Field/date.html.twig", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\FormBundle\\Resources\\views\\Field\\date.html.twig");
    }
}
