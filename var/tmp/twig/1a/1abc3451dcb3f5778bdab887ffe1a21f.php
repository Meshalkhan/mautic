...
class __TwigTemplate_e887ef4462df4cc40a04f882c76ca8fb extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield from $this->unwrap()->yieldBlock('_updatecompany_action_widget', $context, $blocks);
        yield from [];
    }
     ...
     */
    public function block__updatecompany_action_widget(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 2
        yield "  <div class=\"row\">
    <div class=\"col-xs-12\">
      <h4 class=\"mb-sm\">";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.company.update.action.help"), "html", null, true);
        yield "</h4>
    </div>
    ";
        // line 6
