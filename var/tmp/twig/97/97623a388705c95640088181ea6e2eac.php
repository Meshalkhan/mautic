...
class __TwigTemplate_73cc13558dc0e8d48cd66225a1df134e extends Template
{
...
<head>
    ...
    <script>
        ...
        if ((isset($context["relative_path"]) || array_key_exists("relative_path", $context) ? $context["relative_path"] : (function () { throw new RuntimeError('Variable "relative_path" does not exist.', 27, $this->source); })())) {
            // line 28
            yield "                        window.opener.CKEDITOR.tools.callFunction(funcNum, '";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["pathPrefix"]) || array_key_exists("pathPrefix", $context) ? $context["pathPrefix"] : (function () { throw new RuntimeError('Variable "pathPrefix" does not exist.', 28, $this->source); })()), "html", null, true);
            ...
            // line 30
            yield "                        window.opener.CKEDITOR.tools.callFunction(funcNum, file.url);
                        ";
        }
        // line 32
        yield "                        window.close();
...
";
    ...
    {
        return array (  96 => 32,  92 => 30,  84 => 28,  82 => 27,  76 => 24,  72 => 23,  68 => 22,  50 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@FMElfinder/Elfinder/ckeditor.html.twig", "C:\\xampp\\htdocs\\mautic\\vendor\\helios-ag\\fm-elfinder-bundle\\src\\Resources\\views\\Elfinder\\ckeditor.html.twig");
    }
}
