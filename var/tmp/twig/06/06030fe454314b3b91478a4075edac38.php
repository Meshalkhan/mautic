...
class __TwigTemplate_bba421cbed6b7f14aaf2afb76e8374ea extends Template
{
    private $source;
    private $macros = [];
...
<html>
    <head>
        ...
        // line 9
        echo $this->extensions['Mautic\CoreBundle\Twig\Extension\AssetExtension']->getAssetUrl((("themes/" . (isset($context["template"]) || array_key_exists("template", $context) ? $context["template"] : (function () { throw new RuntimeError('Variable "template" does not exist.', 9, $this->source); })())) . "/css/neopolitan.css"));
        echo "\" type=\"text/css\" />
