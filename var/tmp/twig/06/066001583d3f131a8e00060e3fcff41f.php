...
/* @bundles/CoreBundle/Assets/js/1.core.js */
class __TwigTemplate_f15ced1ce7eb7ad6bbd50ff4fe640600 extends Template
{
        ...
        Mousetrap.bind('?', function (e) {
            ...
            modalWindow.find('.modal-body').html(function () {
                ...
                sections.forEach(function (section) {
                    var sectionTitle = (section + '').replace(/^([a-z\\u00E0-\\u00FC])|\\s+([a-z\\u00E0-\\u00FC])/g, function (\$1) {
...
";
    ...
    {
        return "@bundles/CoreBundle/Assets/js/1.core.js";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Assets/js/1.core.js", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Assets\\js\\1.core.js");
    }
}
