...
class __TwigTemplate_9d267983fac13a9bc6a9832de32130cd extends Template
{
...
<head>
    ...
    <title>";
        // line 5
        yield $this->extensions['Mautic\CoreBundle\Twig\Extension\SlotExtension']->getSlot("pageTitle", "Mautic");
        yield "</title>
    ...
    ";
        // line 11
        yield $this->extensions['Mautic\CoreBundle\Twig\Extension\AssetExtension']->outputStyles();
        yield "
        ...
        <div id=\"mobile-top-section-wrapper\">
            <div id=\"mobile-top-section-content\">
                ...
                <div style=\"display: none;\" id=\"mobile-notification\">
                    ...
                    <p id=\"mobile-notification-url\" class=\"truncatable short desktop message\">";
        // line 39
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 39, $this->source); })()), "html", null, true);
        yield "</p>
                </div>
                ...
                <div id=\"desktop-notification\">
                    ...
                    <p id=\"desktop-notification-url\" class=\"truncatable mobile message\">";
        // line 51
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 51, $this->source); })()), "html", null, true);
        yield "</p>
                </div>
...
<div id=\"error-box\">
    <div id=\"error-message-padding\">
        ...
        // line 114
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 114, $this->source); })()), "html", null, true);
        yield "</span> click on the lock icon to the left of the address. </p>
        </div>
...
";
    ...
    {
        return "@MauticNotification/Popup/index.html.twig";
    }
    ...
    {
        return array (  178 => 114,  112 => 51,  97 => 39,  66 => 11,  61 => 9,  57 => 8,  53 => 7,  48 => 5,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@MauticNotification/Popup/index.html.twig", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\NotificationBundle\\Resources\\views\\Popup\\index.html.twig");
    }
}
