...
/* @bundles/UserBundle/Config/config.php */
class __TwigTemplate_ed680568bef74b0a4c59f724e29c180c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/UserBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/UserBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\UserBundle\\Config\\config.php");
    }
}
