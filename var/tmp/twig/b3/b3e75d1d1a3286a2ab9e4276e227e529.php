...
class __TwigTemplate_cbe04bfe4ca92c339736a6a24031a02f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "// Mautic note: Seem to be coming from bootstrap-overflow-navs.js but this library seem to be modifield for Mautic so cannot be simply replaced with the original one via npm.
