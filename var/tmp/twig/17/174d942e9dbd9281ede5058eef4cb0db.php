...
class __TwigTemplate_28284820c226a611042162815343df9c extends Template
{
    ...
    <div class=\"bundle-form-header mb-15\">
        <h3>";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.campaign.leadsource.header.singular"), "html", null, true);
        yield "</h3>
        <h6 class=\"text-muted\">";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((("mautic.campaign.leadsource." . (isset($context["sourceType"]) || array_key_exists("sourceType", $context) ? $context["sourceType"] : (function () { throw new RuntimeError('Variable "sourceType" does not exist.', 4, $this->source); })())) . ".tooltip")), "html", null, true);
        yield "</h6>
    </div>
    ";
        // line 6
...
";
    ...
    {
        return array (  59 => 7,  55 => 6,  50 => 4,  46 => 3,  42 => 1,);
    }
