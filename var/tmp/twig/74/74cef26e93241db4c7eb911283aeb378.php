...
/* @bundles/LeadBundle/Config/config.php */
class __TwigTemplate_d5e0367de67f46ac2467ecbda63c573f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/LeadBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/LeadBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\LeadBundle\\Config\\config.php");
    }
}
