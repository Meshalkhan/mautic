...
/* @bundles/IntegrationsBundle/Config/config.php */
class __TwigTemplate_6bad1f5c04b0caac55662d7dd0456c56 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/IntegrationsBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/IntegrationsBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\IntegrationsBundle\\Config\\config.php");
    }
}
