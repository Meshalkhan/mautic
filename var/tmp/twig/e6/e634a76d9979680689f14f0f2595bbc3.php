...
/* @bundles/InstallBundle/Command/InstallCommand.php */
class __TwigTemplate_d75a039b9d866e3781ccb7b72ec95dff extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/InstallBundle/Command/InstallCommand.php";
    }
    ...
    {
        return new Source("", "@bundles/InstallBundle/Command/InstallCommand.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\InstallBundle\\Command\\InstallCommand.php");
    }
}
