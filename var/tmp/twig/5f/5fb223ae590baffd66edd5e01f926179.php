...
/* @bundles/LeadBundle/EventListener/TypeOperatorSubscriber.php */
class __TwigTemplate_ae249011399580d39af1fdb3ccc308b9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/LeadBundle/EventListener/TypeOperatorSubscriber.php";
    }
    ...
    {
        return new Source("", "@bundles/LeadBundle/EventListener/TypeOperatorSubscriber.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\LeadBundle\\EventListener\\TypeOperatorSubscriber.php");
    }
}
