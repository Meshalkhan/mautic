...
class __TwigTemplate_48fa8dd397c3521c4e8999d3148a60de extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "mautic.install.composer.dependencies=\"Vendor libraries must be installed. If you are running Mautic from source, please run 'composer install'. If you downloaded Mautic, please check for the 'vendor' folder.\"
...
";
    ...
    {
        return new Source("", "@bundles/InstallBundle/Translations/en_US/messages.ini", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\InstallBundle\\Translations\\en_US\\messages.ini");
    }
}
