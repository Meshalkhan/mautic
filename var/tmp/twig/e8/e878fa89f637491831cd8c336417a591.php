...
class __TwigTemplate_bcc4980447876112c3a844181c6c8029 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        <table class=\"table table-hover monitoring-list\" id=\"monitoringTable\">
            ...
            <tr>
                ";
            // line 6
            echo twig_include($this->env, $context, "@MauticCore/Helper/tableheader.html.twig", ["checkall" => "true", "target" => "#monitoringTable", "langVar" => "mautic.social.monitoring", "routeBase" => "social", "templateButtons" => ["delete" => $this->extensions['Mautic\CoreBundle\Twig\Extension\SecurityExtension']->isGranted("mauticSocial:monitoring:delete")]]);
            // line 14
            echo "

                ";
            // line 16
            echo twig_include($this->env, $context, "@MauticCore/Helper/tableheader.html.twig", ["sessionVar" => "social.monitoring", "orderBy" => "e.title", "text" => "mautic.core.title", "class" => "col-monitoring-title", "default" => true]);
            // line 22
            echo "

                ";
            // line 24
            echo twig_include($this->env, $context, "@MauticCore/Helper/tableheader.html.twig", ["sessionVar" => "social.monitoring", "orderBy" => "e.id", "text" => "mautic.core.id", "class" => "visible-md visible-lg col-asset-id"]);
            // line 29
            echo "
            </tr>
            </thead>
...
$context["item"], "model" => "social.monitoring"]);
                ...
                echo "
                                <a href=\"";
                // line 53
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_social_action", ["objectAction" => "view", "objectId" => twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 53)]), "html", null, true);
...
";
            ...
            // line 81
            echo "    ";
            echo twig_include($this->env, $context, "@MauticCore/Helper/noresults.html.twig", ["tip" => "mautic.mautic.social.monitoring.noresults.tip"]);
            echo "
";
        }
        // line 83
...
";
        // line 84
        echo twig_include($this->env, $context, "@MauticCore/Helper/modal.html.twig", ["id" => "MonitoringPreviewModal", "header" => false]);
        // line 87
        echo "
";
    }
    ...
    {
        return array (  169 => 87,  167 => 84,  164 => 83,  158 => 81,  153 => 78,  151 => 73,  150 => 72,  149 => 71,  148 => 70,  142 => 66,  125 => 63,  122 => 62,  116 => 59,  113 => 58,  111 => 57,  105 => 54,  101 => 53,  98 => 52,  96 => 50,  95 => 49,  89 => 45,  87 => 37,  86 => 36,  82 => 34,  65 => 33,  59 => 29,  57 => 24,  53 => 22,  51 => 16,  47 => 14,  45 => 6,  39 => 2,  37 => 1,);
    }
