...
/* @bundles/ReportBundle/Builder/MauticReportBuilder.php */
class __TwigTemplate_4f2c44283aec6ef21ac050051e8d6476 extends Template
{
...
final class MauticReportBuilder implements ReportBuilderInterface
{
    ...
    private function configureBuilder(array \$options)
    {
        ...
        // Replace ";
        // line 302
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 302, $this->source); })()), "html", null, true);
        yield " with the count query
        array_walk(\$selectColumns, function (&\$columnValue, \$columnIndex) use (\$countSql): void {
            if (str_contains(\$columnValue, '";
        // line 304
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 304, $this->source); })()), "html", null, true);
        yield "')) {
                \$columnValue = str_replace('";
        // line 305
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 305, $this->source); })()), "html", null, true);
        yield "', \$countSql, \$columnValue);
            }
        });
...
";
    ...
    {
        return "@bundles/ReportBundle/Builder/MauticReportBuilder.php";
    }
    ...
    {
        return array (  354 => 305,  350 => 304,  345 => 302,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@bundles/ReportBundle/Builder/MauticReportBuilder.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\ReportBundle\\Builder\\MauticReportBuilder.php");
    }
}
