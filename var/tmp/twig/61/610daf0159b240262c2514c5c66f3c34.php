...
class __TwigTemplate_0e4e14b59c865677a6a35ebc1f44603b extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.notification.mobile_notifications"), "html", null, true);
    }
...
(isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 37, $this->source); })())]);
  ...
  ";
        // line 42
        echo twig_include($this->env, $context, "@MauticNotification/MobileNotification/_list.html.twig");
        echo "
