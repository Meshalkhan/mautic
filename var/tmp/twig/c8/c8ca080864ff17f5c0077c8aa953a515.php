...
class __TwigTemplate_7712aae1752b57519f6764bc72d87d03 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("inForm", $context)) ? (_twig_default_filter((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 12, $this->source); })()), false)) : (false)), "type" => "url", "id" =>         // line 14
