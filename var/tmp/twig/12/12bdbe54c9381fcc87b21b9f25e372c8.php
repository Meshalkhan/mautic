...
/* @bundles/CampaignBundle/Config/config.php */
class __TwigTemplate_05e0ed15218c1b28c52f6249dfa520ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CampaignBundle/Config/config.php";
    }
    ...
    {
        return new Source("", "@bundles/CampaignBundle/Config/config.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CampaignBundle\\Config\\config.php");
    }
}
