...
/* @bundles/CoreBundle/Loader/ParameterLoader.php */
class __TwigTemplate_d3e6dcad269426f5c0dc0fa42fd457b7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/CoreBundle/Loader/ParameterLoader.php";
    }
    ...
    {
        return new Source("", "@bundles/CoreBundle/Loader/ParameterLoader.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\CoreBundle\\Loader\\ParameterLoader.php");
    }
}
