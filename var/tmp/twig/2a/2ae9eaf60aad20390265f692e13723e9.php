...
class __TwigTemplate_97c0c613cc4190db3c408813eee112d2 extends Template
{
    ...
    <div class=\"col-sm-offset-3 col-sm-6 text-center\">
        ...
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["failedRows"]) || array_key_exists("failedRows", $context) ? $context["failedRows"] : (function () { throw new RuntimeError('Variable "failedRows" does not exist.', 50, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                // line 53
                yield "                        ";
                $context["lineNumber"] = ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "properties", [], "any", false, true, false, 53), "line", [], "any", true, true, false, 53)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "properties", [], "any", false, true, false, 53), "line", [], "any", false, false, false, 53), "N/A")) : ("N/A"));
                // line 54
                yield "                        ";
                $context["failure"] = ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "properties", [], "any", false, true, false, 54), "error", [], "any", true, true, false, 54)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "properties", [], "any", false, true, false, 54), "error", [], "any", false, false, false, 54), "N/A")) : ("N/A"));
                // line 55
        ...
        if ( !(isset($context["complete"]) || array_key_exists("complete", $context) ? $context["complete"] : (function () { throw new RuntimeError('Variable "complete" does not exist.', 63, $this->source); })())) {
            ...
            // line 65
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_import_action", ["objectAction" => "cancel", "object" => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 65, $this->source); })())]), "html", null, true);
            ...
            // line 68
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_import_action", ["objectAction" => "queue", "object" => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 68, $this->source); })())]), "html", null, true);
            yield "\" data-toggle=\"ajax\">
                            ";
            // line 69
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.import.queue.btn"), "html", null, true);
            yield "
                        </a>
                    </div>
                ";
            ...
            yield "                    <div>
                        ";
            // line 74
            $context["indexRouteParams"] = Twig\Extension\CoreExtension::merge((isset($context["indexRouteParams"]) || array_key_exists("indexRouteParams", $context) ? $context["indexRouteParams"] : (function () { throw new RuntimeError('Variable "indexRouteParams" does not exist.', 74, $this->source); })()), ["search" => (($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.lead.searchcommand.import_id") . ":") . CoreExtension::getAttribute($this->env, $this->source,             // line 75
(isset($context["import"]) || array_key_exists("import", $context) ? $context["import"] : (function () { throw new RuntimeError('Variable "import" does not exist.', 75, $this->source); })()), "id", [], "any", false, false, false, 75))]);
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath((isset($context["indexRoute"]) || array_key_exists("indexRoute", $context) ? $context["indexRoute"] : (function () { throw new RuntimeError('Variable "indexRoute" does not exist.', 77, $this->source); })()), (isset($context["indexRouteParams"]) || array_key_exists("indexRouteParams", $context) ? $context["indexRouteParams"] : (function () { throw new RuntimeError('Variable "indexRouteParams" does not exist.', 77, $this->source); })())), "html", null, true);
            yield "\" data-toggle=\"ajax\">
                            ";
            // line 78
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.list.view", ["%objects%" => (isset($context["objectName"]) || array_key_exists("objectName", $context) ? $context["objectName"] : (function () { throw new RuntimeError('Variable "objectName" does not exist.', 78, $this->source); })())]), "html", null, true);
            yield "
                        </a>
                        <a class=\"btn btn-success\" href=\"";
            // line 80
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_import_index", ["object" => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 80, $this->source); })())]), "html", null, true);
            yield "\" data-toggle=\"ajax\">
                            ";
            // line 81
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.view.imports"), "html", null, true);
            yield "
                        </a>
                        <a class=\"btn btn-success\" href=\"";
            // line 83
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mautic_import_action", ["objectAction" => "view", "objectId" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["import"]) || array_key_exists("import", $context) ? $context["import"] : (function () { throw new RuntimeError('Variable "import" does not exist.', 83, $this->source); })()), "id", [], "any", false, false, false, 83), "object" => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 83, $this->source); })())]), "html", null, true);
            yield "\" data-toggle=\"ajax\">
                            ";
            // line 84
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("mautic.lead.import.result.info", ["%import%" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["import"]) || array_key_exists("import", $context) ? $context["import"] : (function () { throw new RuntimeError('Variable "import" does not exist.', 84, $this->source); })()), "name", [], "method", false, false, false, 84)]), "html", null, true);
            yield "
                        </a>
                    </div>
                ";
...
";
    ...
    {
        return array (  269 => 88,  262 => 84,  258 => 83,  253 => 81,  249 => 80,  244 => 78,  239 => 77,  237 => 75,  236 => 74,  233 => 73,  226 => 69,  222 => 68,  217 => 66,  213 => 65,  210 => 64,  208 => 63,  202 => 62,  199 => 61,  195 => 59,  184 => 56,  181 => 55,  178 => 54,  175 => 53,  171 => 52,  168 => 51,  166 => 50,  157 => 46,  153 => 45,  148 => 43,  141 => 41,  138 => 40,  132 => 38,  126 => 36,  124 => 35,  118 => 32,  109 => 30,  104 => 28,  101 => 27,  98 => 26,  95 => 25,  92 => 24,  89 => 23,  86 => 22,  79 => 21,  71 => 18,  64 => 17,  53 => 15,  42 => 13,);
    }
