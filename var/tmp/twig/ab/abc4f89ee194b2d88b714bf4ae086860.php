...
/* @bundles/MarketplaceBundle/Command/InstallCommand.php */
class __TwigTemplate_12ddccf0ebe5b1af0a0e3788344eaf49 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "@bundles/MarketplaceBundle/Command/InstallCommand.php";
    }
    ...
    {
        return new Source("", "@bundles/MarketplaceBundle/Command/InstallCommand.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\MarketplaceBundle\\Command\\InstallCommand.php");
    }
}
