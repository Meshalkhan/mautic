...
class __TwigTemplate_119d13c6303628f5b9819bd3b3b0153c extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("inForm", $context)) ? (_twig_default_filter((isset($context["inForm"]) || array_key_exists("inForm", $context) ? $context["inForm"] : (function () { throw new RuntimeError('Variable "inForm" does not exist.', 12, $this->source); })()), false)) : (false)), "type" => "password", "id" =>         // line 14
