...
class __TwigTemplate_a5a852d2c2c39d8d7d6769ae94ff5f82 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <title>";
        // line 5
        echo $this->extensions['Mautic\CoreBundle\Twig\Extension\SlotExtension']->getSlot("pageTitle", "Mautic");
        echo "</title>
    ...
    ";
        // line 11
        echo $this->extensions['Mautic\CoreBundle\Twig\Extension\AssetExtension']->outputStyles();
        echo "
...
<div id=\"mobile\">
    ...
    <div id=\"mobile-top-section\">
        ...
        // line 39
        echo twig_escape_filter($this->env, (isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 39, $this->source); })()), "html", null, true);
        echo "</p>
                </div>
        ...
        // line 51
        echo twig_escape_filter($this->env, (isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 51, $this->source); })()), "html", null, true);
        echo "</p>
                </div>
...
<div id=\"error-box\">
    <div id=\"error-message-padding\">
        ...
        // line 114
        echo twig_escape_filter($this->env, (isset($context["siteUrl"]) || array_key_exists("siteUrl", $context) ? $context["siteUrl"] : (function () { throw new RuntimeError('Variable "siteUrl" does not exist.', 114, $this->source); })()), "html", null, true);
        echo "</span> click on the lock icon to the left of the address. </p>
        </div>
...
";
    ...
    {
        return array (  173 => 114,  107 => 51,  92 => 39,  61 => 11,  56 => 9,  52 => 8,  48 => 7,  43 => 5,  37 => 1,);
    }
