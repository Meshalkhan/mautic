...
/* @bundles/AssetBundle/Controller/AssetController.php */
class __TwigTemplate_7c1ec654e611d824d3bfa285951612e4 extends Template
{
...
class AssetController extends FormController
{
    ...
    public function newAction(Request \$request, CoreParametersHelper \$parametersHelper, UploaderHelper \$uploaderHelper, AssetModel \$model, \$entity = null)
    {
        ...
        \$maxSizeError = \$this->translator->trans('mautic.asset.asset.error.file.size', [
            '%fileSize%' => '";
        // line 291
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["filesize"]) || array_key_exists("filesize", $context) ? $context["filesize"] : (function () { throw new RuntimeError('Variable "filesize" does not exist.', 291, $this->source); })()), "html", null, true);
        yield "',
            '%maxSize%'  => '";
        // line 292
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["maxFilesize"]) || array_key_exists("maxFilesize", $context) ? $context["maxFilesize"] : (function () { throw new RuntimeError('Variable "maxFilesize" does not exist.', 292, $this->source); })()), "html", null, true);
        yield "',
        ], 'validators');
    ...
    public function editAction(Request \$request, UploaderHelper \$uploaderHelper, AssetModel \$model, \$objectId, \$ignorePost = false)
    {
        ...
        \$maxSizeError = \$this->translator->trans('mautic.asset.asset.error.file.size', [
            '%fileSize%' => '";
        // line 423
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["filesize"]) || array_key_exists("filesize", $context) ? $context["filesize"] : (function () { throw new RuntimeError('Variable "filesize" does not exist.', 423, $this->source); })()), "html", null, true);
        yield "',
            '%maxSize%'  => '";
        // line 424
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["maxFilesize"]) || array_key_exists("maxFilesize", $context) ? $context["maxFilesize"] : (function () { throw new RuntimeError('Variable "maxFilesize" does not exist.', 424, $this->source); })()), "html", null, true);
        yield "',
        ], 'validators');
...
";
    ...
    {
        return "@bundles/AssetBundle/Controller/AssetController.php";
    }
    ...
    {
        return array (  476 => 424,  472 => 423,  338 => 292,  334 => 291,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@bundles/AssetBundle/Controller/AssetController.php", "C:\\xampp\\htdocs\\mautic\\app\\bundles\\AssetBundle\\Controller\\AssetController.php");
    }
}
